    ...
    return (
        <div>
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="text-3xl font-bold font-jost text-center">Contact Us</h2>
                <p className="mb-8 lg:mb-10 mt-3 text-center text-gray-500 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
                <form action="#" className="space-y-8">
                    ...
                    <button type="submit" className=" bg-[#C1032F]  p-3 w-3/12 text-white hover:text-white font-semibold rounded-lg">Send message</button>
                </form>
            </div>
        </div>
    );
